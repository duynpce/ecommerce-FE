export const environment = {
  ...
  REMOTE_LOGIN_API_URL: 'http://localhost:8080/realms/user/protocol/openid-connect/auth?client_id=shopping-client&redirect_uri=http://localhost:4200/callback/remote&response_type=code&scope=openid'
